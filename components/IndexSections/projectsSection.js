      ...
      <div className="container mx-auto flex justify-center items-start pt-20">
        <div className="w-full">
          ...
          <div className="bg-burg h-84">
            <div className="flex w-full justify-between items-center text-white text-2xl font-bold pt-4 px-6">
              <h3
                data-aos="fade-down"
                data-aos-delay="200"
                data-aos-duration="500"
              ...
              <span className="flex items-center">
                ...
                <div
                  className="transform text-5xl text-white inline-block -rotate-45 cursor-pointer"
